"""Build factor.csv for the 20-day downside idiosyncratic volatility factor.

For each stock and date T, use the latest 20 visible daily returns ending at T:

    r_i = a + b * r_mkt_i + e_i
    downside_ivol_20d(T) = std(min(e_i, 0))
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build downside_ivol_20d factor CSV.")
